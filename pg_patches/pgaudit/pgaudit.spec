...
BuildRequires:  gcc
BuildRequires:  percona-postgresql12-server >= 12
BuildRequires:  percona-postgresql12-devel >= 12
BuildRequires:  openssl-devel percona-postgresql-common

Requires:       percona-postgresql12
Requires:       percona-postgresql12-libs
Requires:       percona-postgresql12-server

Provides:       pgaudit pgaudit13 pgaudit12
%description
