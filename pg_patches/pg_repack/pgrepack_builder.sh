...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pg_repack/Makefile.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pg_repack/rules.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pg_repack/control.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pg_repack/control.in.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pg_repack/pg_repack.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pg_repack/pg_repack-pg12-makefile-pgxs.patch
    cd ${WORKDIR}
    #
