...
get_sources(){
    ...
    cd debian
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/patroni/rules.patch
    rm -f control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/patroni/control
    ...
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/patroni/spec.patch
