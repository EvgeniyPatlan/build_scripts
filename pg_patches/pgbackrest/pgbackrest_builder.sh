...
get_sources(){
    ...
    wget     wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pgbackrest/control.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/build_scripts/12.1/pg_patches/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
